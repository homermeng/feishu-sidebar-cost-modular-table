...
const resources = {
  en: {
    translation: {
      ...
      clickToSelect:
        "Click on records in the table to add them to the selection.",
      ...
      successMessage:
        'Successfully copied {{count}} records to table "{{tableName}}"',
      ...
      skippedFieldsWarning:
        "Note: Some fields could not be copied ({{fields}})",
    },
  },
  zh: {
    translation: {
      title: "金地上海地区｜景观成本模块化APP",
      currentTable: "当前表格",
      ...
      copyToNewTable: "创建项目景观成本速算表",
      copying: "复制中...",
      noRecordsSelected: "请至少选择一条记录",
      enterTableName: "请输入表名",
      processing: "处理中...",
      ready: '就绪。点击表格中的"slected"字段以选择标准景观模块。',
